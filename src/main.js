import './style.css';
import { defaultConfiguration, swapConfig } from './data/swap-config.js';
...
app.innerHTML = `
  <header class="site-header">
    ...
    <p>SWAP / CONFIGURATOR <sup>01</sup></p>
  </header>
  <main class="configurator-layout">
    ...
    <aside class="configuration-panel">
      <div class="panel-intro"><p class="eyebrow">Bore Labs / 001</p><h1>SWAP <span>ATX</span></h1><p>Composez votre boîtier, pièce par pièce.</p></div>
...
function updateInterface(configuration) {
  viewer.render(configuration, swapConfig);
  renderControls(controls, configuration, swapConfig, store);
  ...
  if (swapConfig.product.productUrl) {
    productLink.href = swapConfig.product.productUrl;
